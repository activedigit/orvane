  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        dir="rtl"
        className={cn(
          'fixed z-50 w-full bg-surface shadow-pop focus:outline-none',
          'bottom-0 start-0 end-0 rounded-t-xl p-5 safe-bottom',
          'sm:bottom-auto sm:start-1/2 sm:top-1/2 sm:max-w-lg sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-xl sm:p-6',
          'rtl:sm:translate-x-1/2',
          className,
        )}
        {...props}
      >
        <div className="mb-4 flex items-start justify-between gap-4">
          ...
          <DialogPrimitive.Close className="rounded-md p-1 text-muted hover:bg-canvas-2 hover:text-ink" aria-label="إغلاق">
            <X className="size-5" />
